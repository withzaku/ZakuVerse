...
export const pricingCategories: PricingCategory[] = [
  ...
  {
    title: "AI & Automation",
    description: "Operational automation, assistants, RAG tools, machine learning prototypes, and AI products.",
    benchmarkNote:
      "Benchmarked against Upwork chatbot, AI engineer, machine learning, and computer vision pricing, plus current AI consulting benchmarks.",
    items: [
      withDiscount(
