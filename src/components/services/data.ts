...
export const startingPriceByTitle: Record<string, number> = {
  ...
  "Headless e-commerce storefront": 399,

  "Cross-platform MVP app": 149,
  "Service booking app": 179,
  "E-commerce mobile app": 399,
  "Mobile app with payments + admin": 299,
  "Premium native-style app": 599,
  "Realtime chat or community app": 599,
  "Fitness or health tracking app": 299,
  "Field operations app": 799,

  "REST API starter": 49,
  "Auth + admin backend": 79,
  "MongoDB + Next.js business portal": 149,
  "SaaS MVP dashboard": 349,
  "Realtime analytics dashboard": 219,
  "Commerce backend system": 349,
  "Multi-tenant SaaS platform": 799,
  ...
  "Multi-agent workflow orchestration": 299,
  "Machine learning model training": 179,
  "Deep learning model implementation": 399,
  ...
  "Kubernetes environment build": 349,
  "GPU/HPC execution environment": 449,
